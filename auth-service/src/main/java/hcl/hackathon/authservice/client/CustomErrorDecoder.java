package hcl.hackathon.authservice.client;

import com.fasterxml.jackson.databind.ObjectMapper;
import hcl.hackathon.authservice.exc.GenericErrorResponse;
import hcl.hackathon.authservice.exc.ValidationException;
